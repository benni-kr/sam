...
> = {
  Exam: {
    badge: "border-violet-300 bg-violet-100 text-violet-900 dark:border-violet-400 dark:bg-violet-800/80 dark:text-violet-100",
  ...
  "Language Exam": {
    badge: "border-rose-200 bg-rose-50 text-rose-900 dark:border-rose-400 dark:bg-rose-800/80 dark:text-rose-100",
  ...
  "Group Event": {
    badge: "border-emerald-300 bg-emerald-100 text-emerald-900 dark:border-emerald-400 dark:bg-emerald-800/80 dark:text-emerald-100",
  ...
  "Private Event": {
    ...
    badge: "border-amber-300 bg-[#fcf5d2] text-amber-900 dark:border-amber-400 dark:bg-amber-800/80 dark:text-amber-100",
    section: "border-amber-200 bg-amber-50/80 dark:border-amber-500 dark:bg-amber-900/50",
    heading: "text-amber-900 dark:text-amber-200",
    accent: "bg-amber-400",
    checkbox: "text-amber-700 dark:text-amber-300",
  },
  Other: {
    badge: "border-sky-300 bg-sky-100 text-sky-900 dark:border-sky-400 dark:bg-sky-800/80 dark:text-sky-100",
