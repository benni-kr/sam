...
> = {
  Exam: {
    badge:
      "border-violet-300 bg-violet-100 text-violet-900 dark:border-violet-300 dark:bg-violet-700 dark:text-violet-100",
    section:
      "border-violet-200 bg-violet-50/80 dark:border-violet-600 dark:bg-violet-900/50",
  ...
  "Language Exam": {
    badge:
      "border-rose-200 bg-rose-50 text-rose-900 dark:border-rose-300 dark:bg-rose-700 dark:text-rose-100",
    section:
      "border-rose-100 bg-rose-50/80 dark:border-rose-600 dark:bg-rose-900/50",
  ...
  "Group Event": {
    badge:
      "border-emerald-300 bg-emerald-100 text-emerald-900 dark:border-emerald-300 dark:bg-emerald-700 dark:text-emerald-100",
    section:
      "border-emerald-200 bg-emerald-50/80 dark:border-emerald-600 dark:bg-emerald-900/50",
  ...
  "Private Event": {
    badge:
      "border-amber-300 bg-[#fcf5d2] text-amber-900 dark:border-amber-300 dark:bg-amber-700 dark:text-amber-100",
    section:
      "border-amber-200 bg-amber-50/80 dark:border-amber-300 dark:bg-amber-900/50",
  ...
  Other: {
    badge:
      "border-sky-300 bg-sky-100 text-sky-900 dark:border-sky-300 dark:bg-sky-700 dark:text-sky-100",
    section:
      "border-sky-200 bg-sky-50/80 dark:border-sky-600 dark:bg-sky-900/50",
