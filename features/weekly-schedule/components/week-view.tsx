...
function WeekDayColumn({
  ...
  return (
    <div className="relative border-r border-slate-200 last:border-r-0 dark:border-slate-700">
...
export function WeekView() {
  ...
  return (
    <section className="flex h-full min-h-0 flex-1 flex-col overflow-hidden rounded-[1.5rem] border border-white/70 bg-white/90 shadow-[0_1px_0_rgba(15,23,42,0.04),0_18px_48px_rgba(15,23,42,0.08)] backdrop-blur dark:border-slate-700/70 dark:bg-slate-900/90 dark:shadow-[0_1px_0_rgba(0,0,0,0.2),0_18px_48px_rgba(0,0,0,0.3)]">
      <div className="grid grid-cols-[4rem_repeat(7,minmax(0,1fr))] border-b border-slate-200 bg-slate-50/90 text-slate-600 dark:border-slate-700 dark:bg-slate-800/90 dark:text-slate-400">
        <div className="flex items-center justify-center border-r border-slate-200 px-1.5 py-2.5 text-[10px] font-semibold uppercase tracking-[0.22em] text-slate-400 dark:border-slate-700 dark:text-slate-500">
          Time
        </div>
        {plannerWeekdays.map((day) => {
          return (
            <div
              key={day}
              className="flex items-center justify-center border-r border-slate-200 px-1.5 py-2.5 last:border-r-0 dark:border-slate-700"
            >
              <div className="text-[12px] font-semibold uppercase tracking-[0.16em] text-slate-700 dark:text-slate-300">
                {day}
              </div>
            </div>
          );
      ...
      >
        <div className="relative border-r border-slate-200 bg-slate-50/80 dark:border-slate-700 dark:bg-slate-800/60">
          <div
            className="absolute inset-0"
            style={
              {
          ...
          {Array.from(
            ...
            <div
              key={hour}
              className="relative flex h-[calc(100%/18)] items-center justify-center text-[9px] font-medium text-slate-500 dark:text-slate-500"
            >
              <span
